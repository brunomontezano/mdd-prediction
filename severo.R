...
### Read datasets ###
setwd("/home/pepper/dox/repos/amanda-masters/severo/")
...
predicoes_rev_dic <- ifelse()

confusionMatrix(predictions_rev_dic, test_matrix$dep_dic, positive="Yes")
