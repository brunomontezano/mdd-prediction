...
write.csv(sensitivities, file="/home/pepper/dox/repos/amanda-masters/data/severe/sensitivities.csv")
write.csv(specificities, file="/home/pepper/dox/repos/amanda-masters/data/severe/specificities.csv")
write.csv(prepare_risk, file="/home/pepper/dox/repos/mdd-prediction/data/severe/predictions.csv")

varImp(model)$importance %>% as.data.frame() %>% arrange(desc(Overall)) %>% head(5)
importance = varImp(model)
importance = importance$importance
write.csv(importance, file="/home/pepper/dox/repos/amanda-masters/data/severe/importance.csv")
